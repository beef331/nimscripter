...
extern intptr_t nimscripter_vmargs_get_int(nimscripter_vm_args, intptr_t);
extern bool nimscripter_vmargs_get_bool(nimscripter_vm_args, intptr_t);
extern double nimscripter_vmargs_get_float(nimscripter_vm_args, intptr_t);
extern nimscripter_pnode_t nimscripter_vmargs_get_node(nimscripter_vm_args,
                                                       intptr_t);
extern char *nimscripter_vmargs_get_string(nimscripter_vm_args, intptr_t);
