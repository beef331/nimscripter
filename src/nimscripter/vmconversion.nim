...
proc toVm*(a: int8): Pnode = newIntNode(nkInt8Lit, a.BiggestInt)
proc toVm*(a: int16): Pnode = newIntNode(nkInt16Lit, a.BiggestInt)
proc toVm*(a: int32): Pnode = newIntNode(nkInt32Lit, a.BiggestInt)
proc toVm*(a: int64): Pnode = newIntNode(nkint64Lit, a.BiggestInt)
proc toVm*(a: int): Pnode = newIntNode(nkIntLit, a.BiggestInt)

proc toVm*(a: uint8): Pnode = newIntNode(nkuInt8Lit, a.BiggestInt)
proc toVm*(a: uint16): Pnode = newIntNode(nkuInt16Lit, a.BiggestInt)
proc toVm*(a: uint32): Pnode = newIntNode(nkuInt32Lit, a.BiggestInt)
proc toVm*(a: uint64): Pnode = newIntNode(nkuint64Lit, a.BiggestInt)
proc toVm*(a: uint): Pnode = newIntNode(nkuIntLit, a.BiggestInt)

proc toVm*(a: float32): Pnode = newFloatNode(nkFloat32Lit, BiggestFloat(a))
proc toVm*(a: float64): Pnode = newFloatNode(nkFloat64Lit, BiggestFloat(a))
proc toVm*(a: string): PNode = newStrNode(nkStrLit, a)
